-- Las misiones recurrentes reutilizan el mismo dungeon_quests.id tras reset.
-- La protección anti-doble pago ya vive en el lock de la misión y done=true;
-- el ledger debe registrar cada pago legítimo como evento nuevo.
