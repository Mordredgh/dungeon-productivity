...
const SHOP_ITEMS = [
  /* Consumibles */
  { id:'potion',       name:'Poción de Concentración', icon:'⚗️', img:'item_potion.png',       cost:80,  desc:'2× XP durante 30 minutos',                     category:'consumible' },
  { id:'scroll',       name:'Pergamino de Prórroga',   icon:'📜', img:'item_scroll.png',        cost:60,  desc:'Extiende el deadline de la misión más urgente', category:'consumible' },
  { id:'amulet',       name:'Amuleto de Protección',   icon:'🧿', img:'item_amulet.png',        cost:120, desc:'Bloquea la próxima pérdida de HP (1 uso)',      category:'consumible' },
  { id:'xpstone',      name:'Piedra de Sabiduría',     icon:'💠', img:'item_xpstone.png',       cost:200, desc:'+150 XP instantáneos',                         category:'consumible' },
  { id:'revival',      name:'Poción de Resurrección',  icon:'💊', img:'item_revival.png',       cost:150, desc:'HP restaurada al máximo al instante',           category:'consumible' },
  { id:'hp_minor',     name:'Poción Menor de HP',      icon:'🧪', img:'item_hp_minor.png',      cost:35,  desc:'+25 HP al instante',                           category:'consumible' },
  { id:'gold_rush',    name:'Monedas del Mercader',    icon:'💰', img:'item_gold_rush.png',     cost:80,  desc:'2× Oro en todas las misiones durante 1 hora',   category:'consumible' },
  { id:'boss_shield',  name:'Escudo Anti-Boss',        icon:'🛡️', img:'item_boss_shield.png',   cost:150, desc:'Bloquea la penalización del Jefe esta semana', category:'consumible' },
  { id:'xp_scroll_sm', name:'Pergamino de Poder',      icon:'📜', img:'item_xp_scroll_sm.png',  cost:70,  desc:'+75 XP instantáneos',                          category:'consumible' },
  /* Huevos de mascotas */
  ...
  /* Armas (comunes) */
  { id:'weapon_espada', name:'Espada Común',   icon:'⚔️', img:'arma_espada_comun.png', cost:50, desc:'Arma · mano principal · forjable a Rara (×5)',   category:'armas', weaponKey:'espada', tier:'comun' },
  { id:'weapon_mazo',   name:'Mazo Común',     icon:'🔨', img:'arma_mazo_comun.png',   cost:50, desc:'Arma · mano principal · forjable a Rara (×5)',   category:'armas', weaponKey:'mazo',   tier:'comun' },
  { id:'weapon_baculo', name:'Báculo Común',   icon:'🪄', img:'arma_baculo_comun.png', cost:50, desc:'Arma · mano principal · forjable a Rara (×5)',   category:'armas', weaponKey:'baculo', tier:'comun' },
  { id:'weapon_arco',   name:'Arco Común',     icon:'🏹', img:'arma_arco_comun.png',   cost:50, desc:'Arma · mano principal · forjable a Rara (×5)',   category:'armas', weaponKey:'arco',   tier:'comun' },
  { id:'weapon_dagas',  name:'Dagas Comunes',  icon:'🗡️', img:'arma_dagas_comun.png',  cost:40, desc:'Arma · mano secundaria · forjable a Rara (×5)', category:'armas', weaponKey:'dagas',  tier:'comun' },
  /* Armaduras (comunes) — forjables igual que armas */
  { id:'armor_pecho',   name:'Pecho Común',    icon:'🧱', img:'arma_pecho_comun.png',   cost:60, desc:'+4 HP máx · forjable a Rara (×5)', category:'armaduras', weaponKey:'pecho',   tier:'comun' },
  { id:'armor_casco',   name:'Casco Común',    icon:'⛑️', img:'arma_casco_comun.png',   cost:55, desc:'+4% XP · forjable a Rara (×5)',    category:'armaduras', weaponKey:'casco',   tier:'comun' },
  { id:'armor_botas',   name:'Botas Comunes',  icon:'👢', img:'arma_botas_comun.png',   cost:55, desc:'+4% Oro · forjable a Rara (×5)',   category:'armaduras', weaponKey:'botas',   tier:'comun' },
  { id:'armor_guantes', name:'Guantes Comunes',icon:'🧤', img:'arma_guantes_comun.png', cost:50, desc:'+3% XP · forjable a Rara (×5)',    category:'armaduras', weaponKey:'guantes', tier:'comun' },
  { id:'armor_grebas',  name:'Grebas Comunes', icon:'🦵', img:'arma_grebas_comun.png',  cost:50, desc:'+3 HP máx · forjable a Rara (×5)', category:'armaduras', weaponKey:'grebas',  tier:'comun' },
